...
export const metadata: Metadata = {
  ...
  // ADD THIS: Configure favicon/icons for browser tab
  icons: {
    icon: '/logo.svg', // This will show in the browser tab
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.sapphirebroking.com/logo-black.svg" }],
    type: "website",
  },
};
