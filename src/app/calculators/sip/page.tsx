    ...
    <div className="min-h-screen bg-white pt-20 ">
      <div className="max-w-7xl mx-auto px-4">
          ...
          <div>
            ...
            <div className="flex mb-6">
              <div className="flex rounded-full border border-gray-200 bg-white p-1">
                <button
                  className={`px-10 py-3 font-semibold rounded-full transition-colors duration-200 h-15 ${
                    activeTab === 'SIPs'
                ...
                <button
                  className={`px-10 py-3 font-semibold rounded-full transition-colors duration-200 ${
                    activeTab === 'Lumpsum'
                      ? 'bg-[#064D51] text-white w-[182px]'
                      : 'bg-transparent text-gray-500 w-[182px]'
                  }`}
            ...
            <div className="bg-white border border-gray-200 rounded-xl shadow-sm flex flex-col md:flex-row gap-6 items-stretch" style={{ minHeight: '420px', height: '340px' }}>
              {/* Left Panel - Controls */}
              <div className="w-full md:w-1/2 space-y-6 py-8 px-4 md:px-6 flex flex-col h-full">
                ...
                <div>
                  ...
                  <input
                    ...
                    style={
                      {
                        '--range-progress': `${((investment - 1000) / (100000 - 1000)) * 100}%`
                      } as any
                    }
                  />
                </div>
        ...
        <div className="max-w-7xl mx-auto px-20 pb-12">
          <h2 className="text-[24px] mb-2 mt-8 font-poppins">What is a SIP Calculator (Systematic Investment Plan)?</h2>
          ...
          <p className="text-[#5F5F5F] font-weight-400 font-poppins text-[16px] ">
        ...
        <div className="max-w-7xl mx-auto px-20 pb-12">
          <h2 className="text-[24px] font-poppins mb-2 mt-8">How Does the Sapphire SIP Return Calculator Help You?</h2>
          <p className="text-[#5F5F5F] font-weight-500 mb-2 font-poppins text-[16px]">The Sapphire Broking SIP Return Calculator empowers investors in multiple ways:</p>
        ...
        <div className="max-w-7xl mx-auto px-20 pb-12">
          <h2 className="text-[24px] font-poppins mb-2 mt-8">How to Use the Sapphire SIP Calculator?</h2>
          <p className="text-[#5F5F5F] font-weight-400 mb-2 font-poppins text-[16px]">Using Sapphire's SIP calculator is easy and quick. Just follow these steps:</p>
          <ol className="list-decimal list-inside text-[#5F5F5F] space-y-1 pl-4 font-weight-400">
        ...
        <div className="max-w-7xl mx-auto px-20 pb-8">
          <h2 className="text-[24px] font-poppins mb-2">Example: SIP Returns with Sapphire Broking</h2>
          <p className="text-[#5F5F5F] font-weight-400 mb-2 font-poppins text-[16px]">Let's take a simple scenario:</p>
        ...
        <div className="max-w-7xl mx-auto px-20 pb-8">
          <h2 className="text-[24px] font-poppins mb-2">Why Choose SIP Over Lump-Sum Investments?</h2>
          <p className="text-[#5F5F5F] font-weight-400 mb-2 font-poppins text-[16px]">While both investment methods have their place, SIPs offer unique benefits for long-term investors:</p>
          <ol className="list-decimal list-inside text-[#5F5F5F] space-y-1 pl-4 font-weight-400">
            <li><span className="font-poppins text-[16px] font-weight-500">Rupee Cost Averaging:</span> Buy more units when markets dip and fewer when markets rise—reducing timing risk.</li>
            <li><span className="font-poppins text-[16px] font-weight-500">Disciplined Savings:</span> Automate your investment journey and develop a savings routine.</li>
            <li><span className="font-poppins text-[16px] font-weight-500">Power of Compounding:</span> Earn returns not just on your investments but also on past returns.</li>
            <li><span className="font-poppins text-[16px] font-weight-500">Lower Entry Barrier:</span> No need for large capital upfront—you can begin with as little as ₹500/month.</li>
            <li><span className="font-poppins text-[16px] font-weight-500">Flexibility and Control:</span> Pause, increase, or decrease your SIP amounts based on your financial comfort.</li>
          </ol>
        </div>

        {/* Conclusion */}
        <div className="max-w-7xl mx-auto px-20 pb-12">
          <h2 className="text-[24px] font-poppins mb-2">Conclusion</h2>
          <p className="text-[#5F5F5F] font-weight-400 mb-2 font-poppins text-[16px]">The Sapphire Broking SIP Calculator is a must-have tool for any investor looking to build wealth systematically. Whether you're saving for your child's future, retirement, or any long-term goal, the SIP calculator helps you plan with confidence.</p>
          <p className="text-[#5F5F5F] font-weight-400 mb-2 font-poppins text-[16px]">With Sapphire's easy-to-use interface, you can:</p>
          <ul className="list-disc list-inside text-[#5F5F5F] space-y-1 pl-4 font-weight-400">
            <li>Project returns</li>
            <li>Compare investment strategies</li>
            <li>Stay committed to your financial aspirations</li>
          </ul>
          <p className="text-[#5F5F5F] font-weight-400 mb-2 font-poppins text-[16px]">Start planning smarter with the <a href="#" className="text-[#5F5F5F] underline">Sapphire SIP Calculator</a> today and unlock the power of consistent, goal-driven investing.</p>
        </div>
      </div>
