    ...
    <div className="min-h-screen bg-white pt-20 px-4">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-20 pb-12">
        ...
        <ul className="list-disc list-inside text-[#636363] space-y-1 pl-4 mb-2 text-sm sm:text-base">
          ...
          <li><span className="font-medium">Cost Optimization:</span> Choose trades that minimize fees and maximize profits.</li>
          <li><span className="font-medium">Informed Decisions:</span> Know your true profit potential upfront.</li>
        </ul>
      </div>
