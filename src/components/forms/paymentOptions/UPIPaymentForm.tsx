    ...
    <div className="mx-auto w-full">
      ...
      <div className="mt-8">
        <div className="flex justify-center items-center gap-6">
          <Image src="/new-signup/upi/gpay.svg" alt="Google Pay" width={24} height={24} />
          <Image src="/new-signup/upi/phonepe.svg" alt="PhonePe" width={24} height={24} />
          <Image src="/new-signup/upi/paytm.svg" alt="Paytm" width={24} height={24} />
          <Image src="/new-signup/upi/bhim.svg" alt="BHIM" width={24} height={24} />
        </div>
      </div>
    </div>
  );
