  ...
  return ( 
    <>
      ...
      <div className="w-full bg-[#F5F7FA] flex flex-col items-center py-6 px-4 mt-8 space-y-4 md:hidden">
        ...
        <div className="relative w-full flex justify-center items-start mb-2" style={{height: '170px'}}>
          {/* Circle */}
          <div className="absolute left-1/2 -translate-x-1/2 top-0 w-[150px] h-[150px] bg-[#E6EBF2] rounded-full z-0"></div>
          {/* Phone image, half inside the circle, half outside */}
          <div className="absolute left-1/2 -translate-x-1/2 top-[65px] w-[100px] h-[120px] z-10 flex items-start justify-center">
            <Image 
              src="/minor-demat/mobile.png" 
              alt="Mobile App Screenshot" 
              width={100} 
