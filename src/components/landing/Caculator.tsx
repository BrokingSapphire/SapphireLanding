    ...
    <section className="bg-[#F5F7FA] py-8 sm:py-12 md:py-16">
      <div className="max-w-7xl flex flex-col-reverse md:flex-col lg:flex-row justify-between items-center mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="w-full lg:w-1/2 mt-6 md:mt-0">
          <h1 className="text-2xl sm:text-3xl font-bold text-black mb-4 sm:mb-6 text-center lg:text-left">
        ...
        {/* Illustration Image */}
        <div className="w-full flex justify-center lg:w-auto lg:mt-0 relative lg:left-[-130px] mb-4 md:mb-6 lg:mb-0">
          <Image
            src="/Calc.png"
