            ...
            <tbody>
              {displayContracts.map((contract, idx) => (
                ...
                >
                  ...
                  <td className="py-3 px-2 sm:px-4 text-gray-600 text-sm sm:text-base">1000</td>
                  <td className="py-3 px-2 sm:px-4 text-gray-600 text-sm sm:text-base">₹ 2,58,125.0</td>
