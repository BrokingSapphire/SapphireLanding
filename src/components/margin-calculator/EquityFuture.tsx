...
interface EquityFutureMarginCalculatorProps {
  searchQuery?: string;
  setSearchQuery?: (value: string) => void;
  filteredContracts?: Contract[];
}

const EquityFutureMarginCalculator: React.FC<EquityFutureMarginCalculatorProps> = ({ 
  searchQuery = '', 
  setSearchQuery = () => {}, 
  filteredContracts = [] 
}) => {
        ...
        <table className="w-full border-collapse border border-gray-200">
          ...
          <tbody>
            <tr className="border-b border-gray-200 hover:bg-gray-50 bg-[#F5F7FA]">
              ...
              <td className="py-3 px-4 text-gray-600 font-medium">360ONE</td>
              <td className="py-3 px-4 text-gray-600">31 Jul 2025</td>
              <td className="py-3 px-4 text-gray-600">500</td>
              <td className="py-3 px-4 text-gray-600">₹ 1,61,751.5</td>
            ...
            <tr className="border-b border-gray-200 hover:bg-gray-50 bg-white">
              ...
              <td className="py-3 px-4 text-gray-600">500</td>
              <td className="py-3 px-4 text-gray-600">₹ 1,62,362.5</td>
              <td className="py-3 px-4 text-gray-600">0</td>
            </tr>
            <tr className="border-b border-gray-200 hover:bg-gray-50 bg-[#F5F7FA]">
              ...
              <td className="py-3 px-4 text-gray-600">500</td>
              <td className="py-3 px-4 text-gray-600">₹ 1,62,981.5</td>
              <td className="py-3 px-4 text-gray-600">0</td>
            </tr>
            <tr className="border-b border-gray-200 hover:bg-gray-50 bg-white">
              <td className="py-3 px-4 text-gray-600">4</td>
              <td className="py-3 px-4 text-gray-600 font-medium">AARTIIND</td>
              <td className="py-3 px-4 text-gray-600">31 Jul 2025</td>
              <td className="py-3 px-4 text-gray-600">1325</td>
              <td className="py-3 px-4 text-gray-600">₹ 1,48,188.58</td>
              <td className="py-3 px-4 text-gray-600">0</td>
            </tr>
          </tbody>
        </table>
...
export default EquityFutureMarginCalculator;